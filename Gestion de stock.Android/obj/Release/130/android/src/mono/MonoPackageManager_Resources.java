...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Gestion de stock.Android.dll" comes first in this list. */
		"Gestion de stock.Android.dll",
		"FormsViewGroup.dll",
		"FutureState.AppCore.Data.dll",
		"FutureState.AppCore.Data.Sqlite.Android.dll",
		"FutureState.AppCore.Data.Sqlite.dll",
		"Gestion de stock.dll",
		"SQLite-net.dll",
